...
const ElectronicsRentalPage = () => {
  ...
  const filteredElectronics = filter === "all" ? electronics : electronics.filter((item) => item.type === filter)
        ...
        <div className="mt-8 mb-12 flex justify-center">
          <div className="inline-flex bg-gray-800 rounded-lg p-1 flex-wrap justify-center">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${
                filter === "laptop" ? "bg-blue-600 text-white" : "text-gray-300 hover:text-white"
              }`}
            >
              Laptops
            </button>
            <button
              ...
              className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${
                filter === "camera" ? "bg-blue-600 text-white" : "text-gray-300 hover:text-white"
              }`}
            >
              Cameras
            </button>
            <button
              ...
              className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${
                filter === "gaming" ? "bg-blue-600 text-white" : "text-gray-300 hover:text-white"
              }`}
            >
              Gaming
            </button>
            <button
              ...
              className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${
                filter === "tablet" ? "bg-blue-600 text-white" : "text-gray-300 hover:text-white"
              }`}
            >
              Tablets
            </button>
                ...
                <div className="p-5">
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-4">
                    ...
                    <div className="flex items-center text-gray-300 col-span-2">
                      ...
                      <span className="text-sm">Availability: {item.availability}</span>
                    </div>
                  </div>
