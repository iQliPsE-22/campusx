...
const VehiclesPage = () => {
  ...
  const filteredVehicles = filter === "all" ? vehicles : vehicles.filter((vehicle) => vehicle.type === filter)

  return (
    <section className="bg-black text-white min-h-dvh py-16 px-4 md:px-8">
      <div className="max-w-7xl mx-auto">
        <Headline text="Rent Vehicles for Your Campus Commute" heading="VEHICLES" className="text-3xl lg:text-5xl" />
        ...
        <div className="mt-8 mb-12 flex justify-center">
          <div className="inline-flex bg-gray-800 rounded-lg p-1">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${
                filter === "car" ? "bg-blue-600 text-white" : "text-gray-300 hover:text-white"
              }`}
            >
              Cars
            </button>
            <button
              ...
              className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${
                filter === "motorcycle" ? "bg-blue-600 text-white" : "text-gray-300 hover:text-white"
              }`}
            >
              Motorcycles
            </button>
            <button
              ...
              className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${
                filter === "scooter" ? "bg-blue-600 text-white" : "text-gray-300 hover:text-white"
              }`}
            >
              Scooters
            </button>
                ...
                <div className="p-5">
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-4">
                    ...
                    <div className="flex items-center text-gray-300 col-span-2">
                      ...
                      <span className="text-sm">Availability: {vehicle.availability}</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-gray-800">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm text-gray-400 ml-1">({vehicle.reviews} reviews)</span>
                    </div>
