          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                type="text"
                id="name"
                className="mt-1 block bg-white text-black w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
